                                ...
                                <div class="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
                                  ...
                                  <div>
                                    <nav class="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
                                        <a href="#" wire:click="previousPage" class="relative inline-flex items-center rounded-l-md px-2 py-2 text-gray-400 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0">
                                        ...
                                        @if ($page > 3)
                                            <a href="#" wire:click="goToPage(1)" class="relative inline-flex items-center px-4 py-2 text-sm font-semibold {{ $page == 1 ? 'text-amber-600' : 'text-gray-900' }} ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0">1</a>
                                            @if ($page > 4)
                                        ...
                                        @for ($i = max(1, $page - 1); $i <= min($totalPages, $page + 1); $i++)
                                            <a href="#" wire:click="goToPage({{ $i }})" class="relative inline-flex items-center {{ $page == $i ? 'text-amber-600' : 'text-gray-900' }} px-4 py-2 text-sm font-semibold ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0">
                                                {{ $i }}
                                            </a>
                                        @endfor
                                        ...
                                        @if ($page < $totalPages - 2)
                                            @if ($page < $totalPages - 3)
                                                <span class="relative inline-flex items-center px-4 py-2 text-sm font-semibold text-gray-700 ring-1 ring-inset ring-gray-300 focus:outline-offset-0">...</span>
                                            @endif
                                            <a href="#" wire:click="goToPage({{ $totalPages }})" class="relative inline-flex items-center px-4 py-2 text-sm font-semibold {{ $page == $totalPages ? 'text-amber-600' : 'text-gray-900' }} ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0">{{ $totalPages }}</a>
                                        @endif

                                        <a href="#" wire:click="nextPage" class="relative inline-flex items-center rounded-r-md px-2 py-2 text-gray-400 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0">
